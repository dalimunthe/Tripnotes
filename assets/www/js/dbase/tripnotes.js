        ...
        tx.executeSql(selectAllStatement, [], function (tx, result) {
            ...
            for (var i = 0, item = null; i < dataset.length; i++) {
                ...
                hasil.innerHTML +=
                    ...
                    '<a data-ajax="true" onclick="goto()" href="#pop1" data-rel="popup" id="btn1" data-inline="true">'+
                    ...
                    '<img class="captioned" src="'+item['gambar']+'" alt="">'+'<br>'+
	 				...
	 				'<span style="text-align:right; font-size:1.5em;font-wight:bold;">'+
                    item['judul']+'</span><br>'+item['tanggal']+'<strong><br>'+item['kategori']+' : </strong> '+
                    item['deskripsi']+ '<br>coordinat : '+item['lintang']+','+item['bujur']+
                    '<br>'+'</p>'+'</div></div></a><br><br></li>';
